				...
				<table>
					...
					<tbody>
						...
						<tr class="odd" scope="row">
							...
							<td class="feature feature--empty"></td>
							<td headers="comp-2" class="td-btn-2"><a class="sidebar-button single-btn" href="<?php echo esc_url(ELEARNING_EDUCATION_PRO_THEME_URL);?>"><?php esc_html_e( 'Go for Premium', 'elearning-education' ); ?></a></td>
						</tr>
					</tbody>
				</table>
			</div>
