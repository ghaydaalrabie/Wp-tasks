 ...
 */
return array(
	'title'      => __( 'Core Search Hero', 'travey' ),
	...
	'content'    => '<!-- wp:columns {"style":{"spacing":{"padding":{"top":"10px","bottom":"10px"}}}} -->
            ...
            <div class="wp-block-column travey-margin-top-n70">
            <!-- wp:cover {"url":"' . esc_url( TRAVEY_URI ) . 'assets/img/beach-sea-coast-water-sand-ocean-1200073-pxhere.com.webp","id":1075,"dimRatio":50,"minHeight":500,"minHeightUnit":"px","isDark":false,"style":{"spacing":{"padding":{"top":"100px","bottom":"100px","right":"0px","left":"0px"}}}} -->
            ...
            <!-- wp:query-title {"type":"archive","textAlign":"center","style":{"typography":{"fontSize":"48px","fontStyle":"normal","fontWeight":"600","textTransform":"uppercase","letterSpacing":"3px"}},"textColor":"white","fontFamily":"primary"} /--></div></div>
            <!-- /wp:cover -->
            </div>
            <!-- /wp:column --></div>
            <!-- /wp:columns -->',
