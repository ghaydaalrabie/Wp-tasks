...
function auto_car_dealership_register_block_patterns() {
	...
	$patterns = array(
		...
		'feature-post-column' => array(
			'title'    => __( 'Feature Post Column', 'auto-car-dealership' ),
			//'inserter' => false,
			'categories' => array( 'auto-car-dealership-query' ),
		),
		'comment-section-1' => array(
			'title'    => __( 'Comment Section 1', 'auto-car-dealership' ),
			'categories' => array( 'auto-car-dealership-comment-sections' ),
		),
	...
	$block_pattern_categories = array(
		...
		'auto-car-dealership-comment-section'   => array( 'label' => __( 'Comment Sections', 'auto-car-dealership' ) ),
	);
