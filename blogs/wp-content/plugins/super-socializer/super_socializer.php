...
function the_champ_save_default_options(){
	...
	add_option('the_champ_sharing', array(
		...
		'horizontal_re_providers' => array('facebook', 'twitter', 'linkedin', 'pinterest', 'reddit', 'whatsapp'),
		...
		'vertical_re_providers' => array('facebook', 'twitter', 'linkedin', 'pinterest', 'reddit', 'whatsapp'),
		'vertical_bg' => '',
		'alignment' => 'left',
		'left_offset' => '-10',
		'right_offset' => '-10',
...
function the_champ_addon_update_notification(){
	if(current_user_can('manage_options')){
		...
		if(defined('HEATEOR_SOCIAL_LOGIN_BUTTONS_VERSION') && version_compare('1.2.11', HEATEOR_SOCIAL_LOGIN_BUTTONS_VERSION) > 0){
			?>
			<div class="error notice">
				<h3>Social Login Buttons</h3>
				<p><?php _e('Update "Social Login Buttons" add-on to version 1.2.11 or above for compatibility with the current version of Super Socializer', 'super-socializer') ?></p>
			</div>
			<?php
		}
