...
return array(
	...
	'content'    => '<!-- wp:columns -->
			...
			<div class="wp-block-cover is-light" style="padding-top:20rem;padding-right:0rem;padding-bottom:10rem;padding-left:0rem;min-height:571px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim"></span><img class="wp-block-cover__image-background wp-image-1301" alt="" src="' . esc_url( TRAVEY_URI ) . 'assets/img/landscape-coast-sky-sunrise-sunset-hill-105304-pxhere.com.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:post-title {"textAlign":"center","style":{"typography":{"fontSize":"48px","textTransform":"uppercase","fontStyle":"normal","fontWeight":"600","letterSpacing":"4px"}},"textColor":"white","fontFamily":"primary"} /--></div></div>
			<!-- /wp:cover --></div>
			<!-- /wp:column --></div>
			<!-- /wp:columns -->',
);
