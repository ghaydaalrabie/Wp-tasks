<!-- wp:group {"tagName":"main","align":"wide","style":{"spacing":{"padding":{"bottom":"30px"}}},"layout":{"inherit":true}} -->
<main class="wp-block-group alignwide" style="padding-bottom: 30px">
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'auto-car-dealership' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'auto-car-dealership' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
