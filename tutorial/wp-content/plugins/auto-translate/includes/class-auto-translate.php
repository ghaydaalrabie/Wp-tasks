...
class Auto_Translate {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Auto_Translate_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'AUTO_TRANSLATE_VERSION' ) ) {
			$this->version = AUTO_TRANSLATE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'auto-translate';
	 ...
	 *
	 * - Auto_Translate_Loader. Orchestrates the hooks of the plugin.
	 * - Auto_Translate_i18n. Defines internationalization functionality.
	 * - Auto_Translate_Admin. Defines all hooks for the admin area.
	 * - Auto_Translate_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-auto-translate-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-auto-translate-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-auto-translate-public.php';

		$this->loader = new Auto_Translate_Loader();
	 ...
	 *
	 * Uses the Auto_Translate_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Auto_Translate_Loader    Orchestrates the hooks of the plugin.
	 */
