 ...
 */
return array(
	'title'      => __( 'Core Archive Hero', 'intrace' ),
	...
	'content'    => '<!-- wp:group {"layout":{"contentSize":""}} -->
            ...
            <div class="wp-block-group" style="padding-top:100px;padding-bottom:200px"><!-- wp:query-title {"type":"archive","textAlign":"center","textColor":"intrace-accent"} /--></div>
            <!-- /wp:group --></div></div>
            <!-- /wp:cover --></div>
            <!-- /wp:group -->',
);
