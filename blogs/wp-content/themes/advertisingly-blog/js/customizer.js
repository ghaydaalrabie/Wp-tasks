 ...
 */
 ...
 ( function( $ ) {
	...
	wp.customize( 'advertisingly_blog_readmore_bg_color', function( value ) {
		value.bind( function( to ) {
			$( '.read-more-blogfeed a' ).css( {
				'background':to
			});
		} );
	} );
	wp.customize( 'advertisingly_blog_readmore_text_color', function( value ) {
		value.bind( function( to ) {
			$( '.read-more-blogfeed a' ).css( {
				'color':to
			});
	...
	wp.customize( 'blogfeed_readmore_color', function( value ) {
		value.bind( function( to ) {
			$( '.read-more-blogfeed a' ).css( {
				'color':to
			});
	...
	wp.customize( 'header_img_textcolor', function( value ) {
		value.bind( function( to ) {
			$( '.bottom-header-title, .bottom-header-paragraph, .readmore-header a' ).css( {
				'color':to
			});
		} );
	} );
