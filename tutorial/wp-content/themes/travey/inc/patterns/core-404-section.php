...
return array(
	...
	'content'    => '<!-- wp:group {"layout":{"wideSize":"","contentSize":""}} -->
			...
			<div class="wp-block-column"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"30px"}}},"textColor":"white","fontSize":"extra-large"} -->
			<h2 class="has-text-align-center has-white-color has-text-color has-extra-large-font-size" style="margin-bottom:30px">Page Not Found</h2>
			<!-- /wp:heading -->
