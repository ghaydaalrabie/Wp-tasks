...
return array(
	...
	'content'    => '<!-- wp:group {"layout":{"contentSize":""}} -->
			...
			<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"top":"280px","bottom":"380px"}}},"layout":{"contentSize":"1140px"}} -->
			<main class="wp-block-group" style="padding-top:280px;padding-bottom:380px"><!-- wp:columns -->
			<div class="wp-block-columns"><!-- wp:column {"width":"100%"} -->
			<div class="wp-block-column" style="flex-basis:100%"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"600","textTransform":"capitalize","letterSpacing":"0em","lineHeight":"1"}},"textColor":"intrace-accent","fontSize":"extra-large"} -->
			<h2 class="has-text-align-center has-intrace-accent-color has-text-color has-extra-large-font-size" style="font-style:normal;font-weight:600;line-height:1;text-transform:capitalize;letter-spacing:0em">Page Not Found</h2>
			<!-- /wp:heading -->
